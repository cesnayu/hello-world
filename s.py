...
# --- 4. DATA STATIC (DAFTAR SAHAM UNTUK GRID) ---
# Daftar ini diperluas agar Tab 1 menampilkan banyak saham berbeda
GRID_TICKERS = [
    # Banks
    "BBCA.JK", "BBRI.JK", "BMRI.JK", "BBNI.JK", "BRIS.JK", "ARTO.JK", "BBTN.JK",
    # Energy & Mining
    "ADRO.JK", "PTBA.JK", "ITMG.JK", "PGAS.JK", "MDKA.JK", "ANTM.JK", "INCO.JK", "BUMI.JK", "HRUM.JK", "UNTR.JK", "MEDC.JK",
    # Tech & Telco
    "GOTO.JK", "TLKM.JK", "ISAT.JK", "EXCL.JK", "BUKA.JK", "EMTK.JK",
    # Consumer & Retail
    "ICBP.JK", "INDF.JK", "UNVR.JK", "MYOR.JK", "KLBF.JK", "AMRT.JK", "MAPI.JK", "ACES.JK",
    # Infra & Property
    "ASII.JK", "JSMR.JK", "SMGR.JK", "INTP.JK", "BSDE.JK", "CTRA.JK", "PWON.JK",
    # Others
    "TOWR.JK", "TBIG.JK", "CPIN.JK", "JPFA.JK"
]
...
] # Pakai list yang sama untuk screener default
...
with tab_grid:
    ...
    # MENGGUNAKAN GRID_TICKERS (40+ Saham) BUKAN LIST LAMA
